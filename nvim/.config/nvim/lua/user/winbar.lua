...
-- --
-- -- Config from https://github.com/ChristianChiarulli/nvim/blob/master/lua/user/winbar.lua
-- local M = {}
...
--         local file_icon, file_icon_color = require("user.nvim-web-devicons").get_icon_color(
--             filename,
--             extension,
--             { default = true }
--         )
