...
local snippets_folder = vim.fn.stdpath "config" .. "/lua/user/snip/snippets/"
...
function _G.snippets_clear()
  ...
  --   package.loaded["user.snip.snippets." .. m] = nil
  -- end
  ls.snippets = setmetatable({}, {
    __index = function(t, k)
      local ok, m = pcall(require, "user.snip.snippets." .. k)
